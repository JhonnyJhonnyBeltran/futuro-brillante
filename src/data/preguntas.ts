...
export const PREGUNTAS_FASE1: Pregunta[] = [
  ...
  },
  {
    ...
    opciones: [
      { clave: "A", texto: "No terminé la ESO — quiero entrar a FP Básica" },
...
const PREGUNTAS_FABRICACION: Pregunta[] = [
  ...
  },
  {
    ...
    fase: 2,
    familia: "FABRICACION",
    texto: "Cuando algo tiene que quedar perfecto, ¿cómo reaccionas?",
    opciones: [
      {
        clave: "A",
        texto: "Me agobia un poco, prefiero que quede bien aunque no sea exacto",
      },
      {
        clave: "B",
        texto: "Me parece bien si tengo a alguien que me guíe al principio",
      },
      {
        clave: "C",
        texto: "Me gusta, disfruto cuando algo queda exactamente como debe",
      },
      {
        clave: "D",
        texto: "Me encanta, soy muy detallista y me molesta cuando algo no cuadra",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    fase: 2,
    familia: "FABRICACION",
    texto: "¿Cómo prefieres trabajar habitualmente?",
    opciones: [
      { clave: "A", texto: "Solo/a, con mis herramientas y sin interrupciones" },
      { clave: "B", texto: "Con un compañero o compañera, ayudándonos" },
      { clave: "C", texto: "Con el ordenador, siguiendo mis propios pasos" },
      { clave: "D", texto: "Coordinando a otras personas y repartiendo tareas" },
      { clave: "E", texto: "Me da igual, me adapto a lo que haya" },
    ],
  },
];
...
const PREGUNTAS_ELECTRICA: Pregunta[] = [
  {
    ...
    opciones: [
      { clave: "A", texto: "A montar cables e instalaciones eléctricas seguras" },
      { clave: "B", texto: "A arreglar y mantener máquinas paso a paso" },
      { clave: "C", texto: "A programar sistemas automáticos y robots" },
      { clave: "D", texto: "A diseñar cómo se conectan y comunican todos los sistemas" },
      { clave: "E", texto: "A leer planos eléctricos complejos y supervisar instalaciones" },
    ],
  },
  {
    id: "P8",
  ...
  },
  {
    ...
    fase: 2,
    familia: "ELECTRICA",
    texto: "¿Qué parte del trabajo te parecería más interesante?",
    opciones: [
      { clave: "A", texto: "Cumplir las normas de seguridad eléctrica al pie de la letra" },
      { clave: "B", texto: "Reparar averías en máquinas combinando mecánica y electricidad" },
      { clave: "C", texto: "Programar autómatas y robots para que trabajen solos" },
      { clave: "D", texto: "Diseñar cómo se conectan y comunican todos los sistemas" },
    ],
  },
  {
    id: "P10",
    fase: 2,
    familia: "ELECTRICA",
    texto: "¿Qué situación te gustaría vivir en tu trabajo?",
    opciones: [
      { clave: "A", texto: "Detectar una avería eléctrica y repararla de forma segura" },
      { clave: "B", texto: "Revisar y poner a punto una máquina industrial" },
      { clave: "C", texto: "Programar una línea de producción automatizada" },
      { clave: "D", texto: "Diseñar y supervisar una instalación eléctrica compleja" },
    ],
  },
];
...
const PREGUNTAS_GESTION: Pregunta[] = [
  ...
  },
  {
    ...
    fase: 2,
    familia: "GESTION",
    texto: "¿Qué tipo de problema te gustaría resolver en el trabajo?",
    opciones: [
      { clave: "A", texto: "Que alguien trabaje en un sitio peligroso sin saberlo" },
      { clave: "B", texto: "Que la producción se retrase por una mala planificación" },
      { clave: "C", texto: "Que los documentos estén mal hechos y nadie los entienda" },
      { clave: "D", texto: "Que el equipo no sepa qué tiene que hacer ni cuándo" },
    ],
  },
  {
    id: "P9",
    ...
    familia: "GESTION",
    texto:
      "Cuando tienes que explicar algo importante a otras personas, ¿cómo te sientes?",
    opciones: [
      {
        clave: "A",
        texto: "Me cuesta, prefiero trabajar con datos o documentos antes que hablar",
      },
      {
        clave: "B",
        texto: "No me importa si me preparo bien, aunque no es lo que más me gusta",
      },
      {
        clave: "C",
        texto: "Me gusta, disfruto explicando y viendo que la gente entiende",
      },
      {
        clave: "D",
        texto: "Me encanta, me siento bien cuando consigo que alguien cambie su forma de actuar",
      },
    ],
  },
  {
...
const PREGUNTAS_DIGITAL: Pregunta[] = [
  ...
  },
  {
    ...
    fase: 2,
    familia: "DIGITAL",
    texto: "Al final del día, ¿qué te gustaría poder decir que has hecho?",
    opciones: [
      { clave: "A", texto: "He programado algo que ahora funciona solo" },
      { clave: "B", texto: "He conseguido que una máquina compleja no fallara" },
      { clave: "C", texto: "He creado un objeto real que antes no existía" },
      { clave: "D", texto: "He conectado sistemas que ahora se entienden entre sí" },
    ],
  },
];
