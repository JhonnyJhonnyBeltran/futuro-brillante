...
const PREGUNTAS_FABRICACION: Pregunta[] = [
  ...
  },
  {
    ...
    fase: 2,
    familia: "FABRICACION",
    texto: "¿Con qué herramienta o método te gustaría trabajar más?",
    opciones: [
      { clave: "A", texto: "Herramientas manuales: llave, destornillador, lima" },
      { clave: "B", texto: "Máquinas de precisión: torno, fresadora, rectificadora" },
      { clave: "C", texto: "Software CAD/CAM para diseñar y programar piezas" },
      { clave: "D", texto: "Hojas de planificación para organizar órdenes de producción" },
      { clave: "E", texto: "Impresora 3D para crear prototipos y piezas digitales" },
    ],
  },
];
